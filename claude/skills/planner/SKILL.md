...
- User wants to start coding immediately with a clear task -- delegate to executor or deep-executor
...
- If the user says "just do it" or "skip planning", delegate to `deep-executor` agent to transition to execution mode. Do NOT implement directly in the planning agent.
